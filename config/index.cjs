  ...
  USERS: [
    {
      ...
      useTemplateId: 'LJyxmWE6Te5hsJj4QTCW2hV7xbL3YEUmoclvSKAvxp4',
...
//         },
        ...
        {
          type: '节日', name: '相爱纪念日', year: '2017', date: '01-14',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: '5oOD4VEorLsrlo4yGCctyikaAiTqpFa1EnuNM7Y98TQ',
